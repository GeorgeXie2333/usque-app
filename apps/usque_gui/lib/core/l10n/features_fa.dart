...
const Map<String, String> kUiWorkflowFa = <String, String>{
  ...
  'cc_upgrade': 'به‌روزرسانی موتور لازم است.',
...
const kNetworkQualityFa = <String, String>{
  ...
  'nq_finding_unsupported':
      'DNS رمزنگاری‌شده در این موتور در دسترس نیست؛ بازگشت به متن ساده مجاز نیست.',
  ...
  'nq_finding_probe_unsafe':
      'کاوش اجرا نشد: وضعیت ایمن لازم یا هویت ذخیره‌شده در دسترس نیست. تونل فعال هرگز تکرار نمی‌شود.',
  ...
  'nq_capability_missing':
      'این موتور کیفیت شبکه را ارائه نمی‌دهد. کنترل‌های اتصال موجود همچنان کار می‌کنند.',
  'nq_empty':
  ...
  'nq_dns_no_capability':
      'این موتور نمی‌تواند از DNS مستقیم رمزنگاری‌شده استفاده کند. تنظیمات ذخیره‌شده حفظ می‌شوند. می‌توانید صریحاً DNS سیستم را انتخاب کنید.',
  'nq_dns_invalid_name':
