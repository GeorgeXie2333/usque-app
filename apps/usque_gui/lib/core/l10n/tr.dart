...
const Map<String, String> kTrCatalog = <String, String>{
  ...
  'diag_deep_disconnected':
      'Bağlı değilken etkin denetimler zaman aşımı ve iptalle sınırlanır, ardından platform durumu karşılaştırılır.',
  ...
  'diag_timeline_subtitle':
      'Yalnızca sınırlı durum olayları; paket içeriği ve ham adresler asla kaydedilmez.',
  'diag_logs_subtitle':
      'Oturumu, zaman çizelgesini, platform sağlık özetini ve temizlenmiş günlükleri dışa aktarın.',
  ...
  'diag_timeline_truncated':
      'En son 100 olay gösteriliyor; paketin sınırlı zaman çizelgesi saklanır.',
  'diag_metric_reconnects': 'Yeniden bağlantılar',
  'diag_metric_fallbacks': 'Geri dönüşler',
  'diag_metric_network_changes': 'Ağ değişiklikleri',
  'diag_metric_queue_high_water': 'Kuyruk tepe değeri',
  'diag_unknown': 'Bilinmiyor',
  'diag_stage': 'Aşama',
  'diag_family': 'Aile',
  'diag_retryable': 'Yeniden denenebilir',
  'diag_fallback_allowed': 'Geri dönüş',
  ...
  'diag_check_engine_control_channel': 'Engine denetim kanalı',
  'diag_check_engine_event_stream': 'Engine olay akışı',
  ...
  'diag_check_frontend_system_proxy_state': 'Sistem vekil durumu',
  'diag_check_physical_network_present': 'Fiziksel ağ',
  'diag_check_physical_ipv4_route': 'Fiziksel IPv4 yolu',
  'diag_check_physical_ipv6_route': 'Fiziksel IPv6 yolu',
  ...
  'diag_check_transport_endpoint_pin': 'Uç nokta pimi',
  'diag_check_transport_fallback_policy': 'Geri dönüş ilkesi',
  'diag_check_tunnel_address_assignment': 'Tünel adresi ataması',
  'diag_check_tunnel_routes': 'Tünel yolları',
  ...
  'diag_check_protection_route_ownership': 'Yol sahipliği',
  'diag_check_protection_recovery_journal': 'Kurtarma günlüğü',
  'diag_fail_ENGINE_UNAVAILABLE': 'Engine kullanılamıyor',
  'diag_fail_AGENT_UNREACHABLE': 'Agent erişilemiyor',
  'diag_fail_VPN_SERVICE_UNAVAILABLE': 'VPN hizmeti kullanılamıyor',
  'diag_fail_PROXY_PORT_IN_USE': 'Vekil bağlantı noktası kullanımda',
  ...
  'diag_fail_ENDPOINT_PIN_MISMATCH': 'Uç nokta pimi eşleşmiyor',
  ...
  'diag_fail_SOCKET_PROTECTION_FAILED': 'Yuva koruması başarısız',
  'diag_fail_SOCKET_AFFINITY_INVALID': 'Yuva ağ bağlaması geçersiz',
  'diag_fail_DNS_APPLY_FAILED': 'DNS uygulama başarısız',
  'diag_fail_ROUTE_APPLY_FAILED': 'Yol uygulama başarısız',
  'diag_fail_KILL_SWITCH_APPLY_FAILED': 'Kill Switch uygulama başarısız',
  'diag_fail_KILL_SWITCH_STATE_MISMATCH': 'Kill Switch durumu eşleşmiyor',
  'diag_fail_SYSTEM_PROXY_STATE_MISMATCH': 'Sistem vekil durumu eşleşmiyor',
  'diag_fail_ROUTE_RESTORE_INCOMPLETE': 'Yol geri yükleme eksik',
  'diag_fail_DNS_RESTORE_INCOMPLETE': 'DNS geri yükleme eksik',
  'diag_fail_SYSTEM_PROXY_STALE': 'Eski sistem vekili',
  'diag_fail_PLATFORM_RECOVERY_PENDING': 'Platform kurtarma bekliyor',
  ...
  'diag_fix_run_release_leak_gate':
      'Yayın sızıntı kapısını bağımsız bir gözlemciyle çalıştırın.',
  'diag_fix_inspect_platform_state':
      'Gerçek durumu platform denetçisiyle doğrulayın.',
  'diag_fix_generate_tunnel_traffic':
      'Az miktarda tünel trafiği oluşturun, sonra yeniden denetleyin.',
  'diag_fix_export_diagnostics':
      'Destek için temizlenmiş bir tanılama paketini dışa aktarın.',
  ...
  'diag_event_endpoint_resolved': 'Uç nokta çözüldü',
  'diag_event_socket_connected': 'Yuva bağlandı',
  ...
  'diag_event_fallback_started': 'H2 geri dönüşü başladı',
  ...
  'diag_event_queue_saturated': 'Gönderme kuyruğu doydu',
  'diag_event_disconnected': 'Bağlantı kesildi',
  'diag_event_failed': 'Bağlantı başarısız',
};
