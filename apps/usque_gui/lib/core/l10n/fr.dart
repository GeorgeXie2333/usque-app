...
const Map<String, String> kFrCatalog = <String, String>{
  ...
  'geo_direct': 'Pays en connexion directe',
  'geo_direct_help':
  ...
  'geo_update_all': 'Mettre à jour les données géo',
  ...
  'geo_chip': '{current} en connexion directe',
  'geo_download_first':
      'Téléchargez les données géo de ce pays avant de l’activer.',
  'geo_update_complete':
      'Données géo : {updated} mises à jour, {current} déjà à jour.',
  'geo_update_failed': 'Échec de la mise à jour des données géo : {current}',
  ...
  'diag_deep_connected':
      'Un tunnel est actif : aucun second chemin de données MASQUE ne sera ouvert ; les contrôles de transport actifs seront marqués ignorés ou avertissement.',
  'diag_deep_disconnected':
      'Hors connexion, les contrôles actifs sont limités par délai et annulation, puis l’état de la plateforme est comparé.',
  ...
  'diag_timeline_subtitle':
      'Uniquement des événements d’état bornés ; le contenu des paquets et les adresses brutes ne sont jamais enregistrés.',
  'diag_logs_subtitle':
      'Exportez la session, la chronologie, le résumé de santé de la plateforme et les journaux assainis.',
  ...
  'diag_timeline_truncated':
      'Les 100 événements les plus récents sont affichés ; la chronologie bornée du paquet est conservée.',
  'diag_metric_reconnects': 'Reconnexions',
  'diag_metric_fallbacks': 'Replis',
  'diag_metric_network_changes': 'Changements réseau',
  'diag_metric_queue_high_water': 'Haut de file d’attente',
  ...
  'diag_check_engine_control_channel': 'Canal de contrôle du moteur',
  'diag_check_engine_event_stream': 'Flux d’événements du moteur',
  ...
  'diag_check_transport_endpoint_pin': 'Pin d’extrémité',
  ...
  'diag_fail_ENGINE_UNAVAILABLE': 'Moteur indisponible',
  'diag_fail_AGENT_UNREACHABLE': 'Agent injoignable',
  ...
  'diag_fail_ENDPOINT_PIN_MISMATCH': 'Pin d’extrémité non concordant',
  ...
  'diag_fail_SYSTEM_PROXY_STALE': 'Proxy système obsolète',
  'diag_fail_PLATFORM_RECOVERY_PENDING':
      'Récupération de plateforme en attente',
  'diag_fail_PACKET_SEND_FAILED': 'Échec d’envoi de paquet',
  'diag_fail_PACKET_SEND_TIMEOUT': 'Délai d’envoi de paquet dépassé',
  ...
  'diag_fail_DIAGNOSTIC_DEPENDENCY_FAILED': 'Dépendance de diagnostic en échec',
  ...
  'diag_fix_refresh_or_replace_identity':
      'Actualisez ou remplacez l’identité avant de reconnecter.',
  ...
  'diag_fix_run_release_leak_gate':
      'Exécutez la barrière de fuite de publication avec un observateur indépendant.',
  'diag_fix_inspect_platform_state':
      'Confirmez l’état réel avec l’inspecteur de la plateforme.',
  'diag_fix_generate_tunnel_traffic':
      'Générez un peu de trafic de tunnel, puis contrôlez à nouveau.',
  'diag_fix_export_diagnostics':
      'Exportez une archive de diagnostic assainie pour l’assistance.',
  ...
  'diag_event_endpoint_resolved': 'Extrémité résolue',
  ...
  'diag_event_fallback_started': 'Repli vers H2 démarré',
  ...
  'diag_event_path_promoted': 'Chemin candidat promu',
  'diag_event_queue_saturated': 'File d’envoi saturée',
