...
pub(super) fn try_send_batch(
    ...
    // UdpBatchIo owns Tokio readiness for the entire batch. Its try_io
    // closure must perform raw I/O: nesting try_send_to repeats readiness
    // handling for every packet and can clear the outer readiness flag.
