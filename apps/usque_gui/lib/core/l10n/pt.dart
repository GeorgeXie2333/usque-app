...
const Map<String, String> kPtCatalog = <String, String>{
  ...
  'geo_chip': '{current} direto',
  'geo_download_first': 'Baixe os dados geo deste país antes de ativá-lo.',
  'geo_update_complete':
      'Dados geo: {updated} atualizados, {current} já estavam atuais.',
  'geo_update_failed': 'Falha ao atualizar os dados geo: {current}',
  ...
  'diag_deep_connected':
      'Há um túnel ativo: nenhum segundo caminho de dados MASQUE será aberto; as verificações ativas de transporte serão marcadas como ignoradas ou aviso.',
  'diag_deep_disconnected':
      'Desconectado, as verificações ativas ficam limitadas por tempo limite e cancelamento; depois o estado da plataforma é comparado.',
  ...
  'diag_timeline_subtitle':
      'Somente eventos de estado limitados; o conteúdo dos pacotes e endereços brutos nunca são registrados.',
  'diag_logs_subtitle':
      'Exporte a sessão, a linha do tempo, o resumo de saúde da plataforma e os logs sanitizados.',
  ...
  'diag_timeline_truncated':
      'Mostrando os 100 eventos mais recentes; a linha do tempo limitada do pacote é mantida.',
  'diag_metric_reconnects': 'Reconexões',
  'diag_metric_fallbacks': 'Fallbacks',
  'diag_metric_network_changes': 'Mudanças de rede',
  'diag_metric_queue_high_water': 'Marca alta da fila',
  ...
  'diag_check_engine_control_channel': 'Canal de controle do Engine',
  'diag_check_engine_event_stream': 'Fluxo de eventos do Engine',
  'diag_check_engine_capabilities': 'Recursos da API',
  ...
  'diag_fail_ENGINE_UNAVAILABLE': 'Engine indisponível',
  'diag_fail_AGENT_UNREACHABLE': 'Agent inacessível',
  ...
  'diag_fail_H3_HANDSHAKE_TIMEOUT': 'Tempo esgotado no handshake H3',
  ...
  'diag_fail_SYSTEM_PROXY_STALE': 'Proxy do sistema obsoleto',
  'diag_fail_PLATFORM_RECOVERY_PENDING': 'Recuperação da plataforma pendente',
  ...
  'diag_fail_PACKET_RECEIVE_STALLED': 'Recebimento de pacote parado',
  'diag_fail_SEND_QUEUE_FULL': 'Fila de envio cheia',
  'diag_fail_DIAGNOSTIC_ALREADY_RUNNING': 'Já há um diagnóstico em execução',
  'diag_fail_DIAGNOSTIC_TIMEOUT': 'Verificação de diagnóstico expirou',
  ...
  'diag_fix_run_release_leak_gate':
      'Execute o gate de vazamento de lançamento com um observador independente.',
  'diag_fix_inspect_platform_state':
      'Confirme o estado real com o inspetor da plataforma.',
  'diag_fix_generate_tunnel_traffic':
      'Gere um pouco de tráfego no túnel e verifique novamente.',
  'diag_fix_export_diagnostics':
      'Exporte um pacote de diagnóstico sanitizado para o suporte.',
  ...
  'diag_event_endpoint_resolved': 'Endpoint resolvido',
  ...
  'diag_event_fallback_started': 'Fallback para H2 iniciado',
  ...
  'diag_event_path_promoted': 'Caminho candidato promovido',
  'diag_event_queue_saturated': 'Fila de envio saturada',
