...
const Map<String, String> kNetworkQualityTh = <String, String>{
  ...
  'nq_doctor_deep_body':
      'การตรวจเชิงลึกอาจส่งคำขอ DNS ทดสอบไปยังตัวแปลงชื่อที่ตั้งไว้ และตรวจสอบเส้นทาง QUIC ที่ป้องกัน ใช้เวลาไม่เกิน 15 วินาที ยกเลิกได้ จะไม่สร้างอุโมงค์ข้อมูลเส้นที่สอง และจะไม่เปลี่ยน DNS เส้นทาง โปรไฟล์ หรือทรานสปอร์ตของคุณ',
