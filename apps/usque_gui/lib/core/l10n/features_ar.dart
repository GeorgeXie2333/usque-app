...
const kNetworkQualityAr = <String, String>{
  ...
  'nq_finding_unsupported':
      'DNS المشفّر غير متاح في هذا المحرك؛ ولا يُسمح بالرجوع إلى النص الواضح.',
  ...
  'nq_finding_probe_unsafe':
      'تم تخطي المجس: الحالة الآمنة المطلوبة أو الهوية المحفوظة غير متاحة. لا يُكرَّر نفق نشط أبدًا.',
  ...
  'nq_capability_missing':
      'لا يوفّر هذا المحرك جودة الشبكة. عناصر التحكم الحالية في الاتصال ما زالت تعمل.',
  ...
  'nq_dns_no_capability':
      'لا يستطيع هذا المحرك استخدام DNS المباشر المشفّر. تُحفظ الإعدادات المحفوظة. يمكنك اختيار DNS النظام صراحةً.',
  ...
  'nq_doctor_deep_body':
      'قد ترسل الفحوصات العميقة استعلام DNS تجريبيًا إلى المحلل الذي هيّأته وتتحقق من مسار QUIC محمي. تدوم 15 ثانية كحد أقصى، ويمكن إلغاؤها، ولا تنشئ نفق بيانات ثانيًا أبدًا، ولا تغيّر DNS أو المسار أو ملف التعريف أو النقل.',
