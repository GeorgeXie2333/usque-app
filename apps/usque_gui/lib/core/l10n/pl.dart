...
const Map<String, String> kPlCatalog = <String, String>{
  ...
  'diag_run_subtitle':
      'Tryb standardowy używa tylko sprawdzeń tylko do odczytu i pasywnych.',
  'diag_mode_standard': 'Standardowa',
  'diag_mode_deep': 'Głęboka',
  'diag_deep_title': 'Informacje o głębokiej diagnostyce',
  'diag_deep_connected':
      'Tunel jest aktywny: drugi szlak danych MASQUE nie zostanie otwarty; aktywne sprawdzenia transportu będą oznaczone jako pominięte lub ostrzeżenie.',
  'diag_deep_disconnected':
      'Bez połączenia aktywne sprawdzenia są ograniczone limitem czasu i anulowaniem, a następnie porównywany jest stan platformy.',
  ...
  'diag_timeline_subtitle':
      'Tylko ograniczone zdarzenia stanu; treść pakietów i surowe adresy nigdy nie są zapisywane.',
  'diag_logs_subtitle':
      'Eksportuj sesję, oś czasu, podsumowanie kondycji platformy i oczyszczone dzienniki.',
  ...
  'diag_timeline_truncated':
      'Pokazywane są ostatnie 100 zdarzeń; ograniczona oś czasu pakietu jest zachowywana.',
  'diag_metric_reconnects': 'Ponowne połączenia',
  'diag_metric_fallbacks': 'Tryby awaryjne',
  'diag_metric_network_changes': 'Zmiany sieci',
  'diag_metric_queue_high_water': 'Wysoki poziom kolejki',
  'diag_unknown': 'Nieznane',
  'diag_stage': 'Etap',
  'diag_family': 'Rodzina',
  'diag_retryable': 'Do ponowienia',
  'diag_fallback_allowed': 'Tryb awaryjny',
  ...
  'diag_check_engine_control_channel': 'Kanał sterowania Engine',
  'diag_check_engine_event_stream': 'Strumień zdarzeń Engine',
  ...
  'diag_check_transport_fallback_policy': 'Zasada trybu awaryjnego',
  ...
  'diag_fail_ENGINE_UNAVAILABLE': 'Engine niedostępny',
  'diag_fail_AGENT_UNREACHABLE': 'Agent nieosiągalny',
  'diag_fail_VPN_SERVICE_UNAVAILABLE': 'Usługa VPN niedostępna',
  'diag_fail_PROXY_PORT_IN_USE': 'Port proxy zajęty',
  'diag_fail_PHYSICAL_IPV4_UNAVAILABLE': 'Fizyczne IPv4 niedostępne',
  'diag_fail_PHYSICAL_IPV6_UNAVAILABLE': 'Fizyczne IPv6 niedostępne',
  ...
  'diag_fail_SYSTEM_PROXY_STALE': 'Przestarzałe proxy systemowe',
  'diag_fail_PLATFORM_RECOVERY_PENDING': 'Odzyskiwanie platformy oczekuje',
  ...
  'diag_fix_run_release_leak_gate':
      'Uruchom bramkę wycieku wydania z niezależnym obserwatorem.',
  'diag_fix_inspect_platform_state':
      'Potwierdź rzeczywisty stan inspektorem platformy.',
  'diag_fix_generate_tunnel_traffic':
      'Wygeneruj niewielki ruch tunelu, a następnie sprawdź ponownie.',
  'diag_fix_export_diagnostics':
      'Wyeksportuj oczyszczony pakiet diagnostyczny dla wsparcia.',
  ...
  'diag_event_endpoint_resolved': 'Rozwiązano punkt końcowy',
  ...
  'diag_event_fallback_started': 'Rozpoczęto tryb awaryjny H2',
  ...
  'diag_event_queue_saturated': 'Kolejka wysyłania nasycona',
