...
const Map<String, String> kIdCatalog = <String, String>{
  ...
  'diag_deep_connected':
      'Terowongan aktif: jalur data MASQUE kedua tidak akan dibuka; pemeriksaan transport aktif akan ditandai dilewati atau peringatan.',
  'diag_deep_disconnected':
      'Saat terputus, pemeriksaan aktif dibatasi waktu habis dan pembatalan, lalu status platform dibandingkan.',
  ...
  'diag_timeline_subtitle':
      'Hanya peristiwa status terbatas; isi paket dan alamat mentah tidak pernah dicatat.',
  'diag_logs_subtitle':
      'Ekspor sesi, linimasa, ringkasan kesehatan platform, dan log yang dibersihkan.',
  ...
  'diag_timeline_truncated':
      'Menampilkan 100 peristiwa terbaru; linimasa terbatas paket tetap disimpan.',
  'diag_metric_reconnects': 'Sambung ulang',
  'diag_metric_fallbacks': 'Cadangan',
  'diag_metric_network_changes': 'Perubahan jaringan',
  'diag_metric_queue_high_water': 'Tinggi antrian',
  'diag_unknown': 'Tidak diketahui',
  'diag_stage': 'Tahap',
  'diag_family': 'Keluarga',
  'diag_retryable': 'Dapat dicoba lagi',
  'diag_fallback_allowed': 'Cadangan',
  ...
  'diag_check_engine_control_channel': 'Saluran kendali Engine',
  'diag_check_engine_event_stream': 'Aliran peristiwa Engine',
  ...
  'diag_check_transport_fallback_policy': 'Kebijakan cadangan',
  ...
  'diag_check_tunnel_ipv4_egress': 'Keluar IPv4',
  'diag_check_tunnel_ipv6_egress': 'Keluar IPv6',
  ...
  'diag_fail_ENGINE_UNAVAILABLE': 'Engine tidak tersedia',
  'diag_fail_AGENT_UNREACHABLE': 'Agent tidak dapat dijangkau',
  ...
  'diag_fail_SYSTEM_PROXY_STALE': 'Proksi sistem usang',
  'diag_fail_PLATFORM_RECOVERY_PENDING': 'Pemulihan platform tertunda',
  ...
  'diag_fail_DIAGNOSTIC_TIMEOUT': 'Pemeriksaan diagnostik habis waktu',
  ...
  'diag_fix_run_release_leak_gate':
      'Jalankan gerbang kebocoran rilis dengan pengamat independen.',
  'diag_fix_inspect_platform_state':
      'Konfirmasikan status sebenarnya dengan pemeriksa platform.',
  'diag_fix_generate_tunnel_traffic':
      'Hasilkan sedikit lalu lintas terowongan, lalu periksa lagi.',
  'diag_fix_export_diagnostics':
      'Ekspor bundel diagnostik yang dibersihkan untuk dukungan.',
  ...
  'diag_event_endpoint_resolved': 'Titik akhir diselesaikan',
  ...
  'diag_event_peer_settings_received': 'Pengaturan rekan diterima',
  ...
  'diag_event_fallback_started': 'Cadangan ke H2 dimulai',
  ...
  'diag_event_path_promoted': 'Jalur kandidat dipromosikan',
  'diag_event_queue_saturated': 'Antrian kirim jenuh',
