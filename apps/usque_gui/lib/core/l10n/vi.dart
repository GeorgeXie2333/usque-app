...
const Map<String, String> kViCatalog = <String, String>{
  ...
  'geo_direct': 'Quốc gia đi trực tiếp',
  'geo_direct_help':
  ...
  'diag_deep_connected':
      'Đường hầm đang hoạt động: sẽ không mở đường dữ liệu MASQUE thứ hai; kiểm tra vận chuyển chủ động sẽ được đánh dấu bỏ qua hoặc cảnh báo.',
  'diag_deep_disconnected':
      'Khi ngắt kết nối, kiểm tra chủ động bị giới hạn bởi hết thời gian và hủy, sau đó so sánh trạng thái nền tảng.',
  ...
  'diag_summary_skipped': 'Bỏ qua {count}',
  ...
  'diag_timeline_subtitle':
      'Chỉ ghi sự kiện trạng thái có giới hạn; nội dung gói và địa chỉ thô không bao giờ được ghi.',
  'diag_logs_subtitle':
      'Xuất phiên, dòng thời gian, tóm tắt sức khỏe nền tảng và nhật ký đã làm sạch.',
  ...
  'diag_timeline_truncated':
      'Đang hiện 100 sự kiện mới nhất; dòng thời gian có giới hạn của gói vẫn được giữ.',
  'diag_metric_reconnects': 'Kết nối lại',
  'diag_metric_fallbacks': 'Dự phòng',
  'diag_metric_network_changes': 'Thay đổi mạng',
  'diag_metric_queue_high_water': 'Mức đỉnh hàng đợi',
  'diag_unknown': 'Không rõ',
  'diag_stage': 'Giai đoạn',
  'diag_family': 'Họ',
  'diag_retryable': 'Có thể thử lại',
  'diag_fallback_allowed': 'Dự phòng',
  ...
  'diag_check_engine_control_channel': 'Kênh điều khiển Engine',
  'diag_check_engine_event_stream': 'Luồng sự kiện Engine',
  ...
  'diag_check_transport_fallback_policy': 'Chính sách dự phòng',
  ...
  'diag_fail_ENGINE_UNAVAILABLE': 'Engine không khả dụng',
  'diag_fail_AGENT_UNREACHABLE': 'Không tới được Agent',
  ...
  'diag_fail_SYSTEM_PROXY_STALE': 'Proxy hệ thống cũ',
  'diag_fail_PLATFORM_RECOVERY_PENDING': 'Khôi phục nền tảng đang chờ',
  ...
  'diag_fail_DIAGNOSTIC_ALREADY_RUNNING': 'Chẩn đoán đã đang chạy',
  'diag_fail_DIAGNOSTIC_TIMEOUT': 'Kiểm tra chẩn đoán hết thời gian',
  ...
  'diag_fix_run_release_leak_gate':
      'Chạy cổng rò rỉ phát hành với một quan sát viên độc lập.',
  'diag_fix_inspect_platform_state':
      'Xác nhận trạng thái thực bằng trình kiểm tra nền tảng.',
  'diag_fix_generate_tunnel_traffic':
      'Tạo một ít lưu lượng đường hầm, rồi kiểm tra lại.',
  'diag_fix_export_diagnostics': 'Xuất gói chẩn đoán đã làm sạch cho hỗ trợ.',
  ...
  'diag_event_endpoint_resolved': 'Đã phân giải điểm cuối',
  'diag_event_socket_connected': 'Socket đã kết nối',
  'diag_event_tls_ready': 'TLS sẵn sàng',
  'diag_event_quic_ready': 'QUIC sẵn sàng',
  'diag_event_masque_accepted': 'MASQUE đã chấp nhận',
  'diag_event_peer_settings_received': 'Đã nhận cài đặt phía đối',
  ...
  'diag_event_fallback_started': 'Đã bắt đầu dự phòng sang H2',
  ...
  'diag_event_path_promoted':
      'Đường ứng viên đã được chuyển thành đường hoạt động',
  'diag_event_queue_saturated': 'Hàng đợi gửi đã bão hòa',
