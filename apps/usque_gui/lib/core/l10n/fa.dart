...
const Map<String, String> kFaCatalog = <String, String>{
  ...
  'diag_event_stream_degraded_body':
      'وضعیت نشست با نظرسنجی محدود در حال بازیابی است؛ اجرا دوباره شروع نمی‌شود.',
  ...
  'diag_export_excluded_body':
      'کلیدها، نشانه‌ها، نام نمایه‌ها، نشانی کامل، SSID، فهرست برنامه‌ها و مسیرهای کاربر',
  ...
  'diag_run_subtitle':
      'حالت استاندارد فقط از بررسی‌های فقط‌خواندنی و غیرفعال استفاده می‌کند.',
  'diag_mode_standard': 'استاندارد',
  'diag_mode_deep': 'عمیق',
  'diag_deep_title': 'درباره تشخیص عمیق',
  'diag_deep_connected':
      'تونل فعال است: مسیر داده MASQUE دوم باز نمی‌شود؛ بررسی‌های انتقال فعال به‌صورت ردشده یا هشدار علامت می‌خورند.',
  'diag_deep_disconnected':
      'هنگام قطع اتصال، بررسی‌های فعال با مهلت و لغو محدود می‌شوند و سپس وضعیت بستر مقایسه می‌شود.',
  ...
  'diag_summary_skipped': 'ردشده {count}',
  'diag_check_results': 'نتایج بررسی',
  'diag_check_results_empty':
      'یک تشخیص را شروع کنید تا بررسی‌ها بر اساس لایه و وابستگی دیده شوند.',
  'diag_timeline': 'خط زمانی اتصال',
  'diag_timeline_subtitle':
      'فقط رویدادهای وضعیت محدود؛ محتوای بسته و نشانی خام هرگز ثبت نمی‌شود.',
  'diag_logs_subtitle':
      'نشست، خط زمانی، خلاصه سلامت بستر و گزارش‌های پاک‌سازی‌شده را صادر کنید.',
  ...
  'diag_timeline_truncated':
      '۱۰۰ رویداد اخیر نمایش داده می‌شود؛ خط زمانی محدود بسته حفظ می‌شود.',
  'diag_metric_reconnects': 'اتصال‌های مجدد',
  'diag_metric_fallbacks': 'عقب‌نشینی‌ها',
  'diag_metric_network_changes': 'تغییرهای شبکه',
  'diag_metric_queue_high_water': 'تراز بالای صف',
  'diag_unknown': 'نامعلوم',
  'diag_stage': 'مرحله',
  'diag_family': 'خانواده',
  'diag_retryable': 'قابل تلاش مجدد',
  'diag_fallback_allowed': 'عقب‌نشینی',
  'diag_copy_support': 'رونوشت اطلاعات پشتیبانی',
  'diag_support_copied': 'اطلاعات پشتیبانی رونوشت شد.',
  'diag_yes': 'بله',
  'diag_no': 'خیر',
  ...
  'diag_check_engine_control_channel': 'کانال کنترل Engine',
  'diag_check_engine_event_stream': 'جریان رویداد Engine',
  'diag_check_engine_capabilities': 'توانایی‌های API',
  'diag_check_engine_configuration': 'پیکربندی',
  'diag_check_engine_secure_storage_metadata': 'فراداده هویت',
  'diag_check_frontend_socks_port': 'شنونده SOCKS5',
  'diag_check_frontend_http_port': 'شنونده HTTP',
  'diag_check_frontend_system_proxy_state': 'وضعیت پیشکار سامانه',
  ...
  'diag_check_transport_fallback_policy': 'سیاست عقب‌نشینی',
  ...
  'diag_fail_ENGINE_UNAVAILABLE': 'Engine در دسترس نیست',
  'diag_fail_AGENT_UNREACHABLE': 'Agent در دسترس نیست',
  'diag_fail_VPN_SERVICE_UNAVAILABLE': 'خدمت VPN در دسترس نیست',
  'diag_fail_PROXY_PORT_IN_USE': 'درگاه پیشکار در حال استفاده است',
  ...
  'diag_fail_SOCKET_AFFINITY_INVALID': 'اتصال شبکه سوکت نامعتبر است',
  ...
  'diag_fail_SYSTEM_PROXY_STATE_MISMATCH': 'وضعیت پیشکار سامانه مطابقت ندارد',
  'diag_fail_ROUTE_RESTORE_INCOMPLETE': 'بازیابی مسیر ناقص است',
  'diag_fail_DNS_RESTORE_INCOMPLETE': 'بازیابی DNS ناقص است',
  'diag_fail_SYSTEM_PROXY_STALE': 'پیشکار سامانه کهنه',
  'diag_fail_PLATFORM_RECOVERY_PENDING': 'بازیابی بستر در انتظار است',
  ...
  'diag_fix_refresh_or_replace_identity':
      'پیش از اتصال مجدد هویت را بازخوانی یا جایگزین کنید.',
  ...
  'diag_fix_run_release_leak_gate':
      'دروازه نشت انتشار را با ناظر مستقل اجرا کنید.',
  'diag_fix_inspect_platform_state': 'وضعیت واقعی را با بازرس بستر تأیید کنید.',
  'diag_fix_generate_tunnel_traffic':
      'مقدار کمی ترافیک تونل ایجاد کنید، سپس دوباره بررسی کنید.',
  'diag_fix_export_diagnostics':
      'بسته تشخیص پاک‌سازی‌شده را برای پشتیبانی صادر کنید.',
  ...
  'diag_event_endpoint_resolved': 'نقطه پایانی حل شد',
  ...
  'diag_event_fallback_started': 'عقب‌نشینی به H2 آغاز شد',
  ...
  'diag_event_queue_saturated': 'صف ارسال اشباع شد',
