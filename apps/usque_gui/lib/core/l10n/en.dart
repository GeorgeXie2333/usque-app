...
const Map<String, String> kEnCatalog = <String, String>{
  ...
  'diag_run_subtitle': 'Standard mode uses read-only and passive checks.',
  ...
  'diag_metric_queue_high_water': 'Queue high-water',
  ...
  'diag_check_engine_control_channel': 'Engine control channel',
  'diag_check_engine_event_stream': 'Engine event stream',
  'diag_check_engine_capabilities': 'API capabilities',
  'diag_check_engine_configuration': 'Configuration',
  'diag_check_engine_secure_storage_metadata': 'Identity metadata',
  ...
  'diag_check_transport_fallback_policy': 'Fallback policy',
  ...
  'diag_fail_ENGINE_UNAVAILABLE': 'Engine unavailable',
  'diag_fail_AGENT_UNREACHABLE': 'Agent unreachable',
  ...
  'diag_fail_SYSTEM_PROXY_STALE': 'Stale system proxy',
  'diag_fail_PLATFORM_RECOVERY_PENDING': 'Platform recovery pending',
  ...
  'diag_event_endpoint_resolved': 'Endpoint resolved',
  ...
  'diag_event_fallback_started': 'Fallback to H2 started',
  ...
  'diag_event_path_promoted': 'Candidate path promoted',
  'diag_event_queue_saturated': 'Send queue saturated',
