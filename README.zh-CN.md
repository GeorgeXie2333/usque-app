...
> [!IMPORTANT]
> 当前发布版本为 **v0.2.0**。请仅从 [GitHub Releases 页面](https://github.com/GeorgeXie2333/usque-app/releases) 下载正式安装包。Pull Request 构建、本地构建以及未打标签的二进制均非正式发布。
...
`v0.2.0` 由 `main` 上的对应标签构建并校验以下六个安装包：
