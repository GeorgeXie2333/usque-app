...
const Map<String, String> kArCatalog = <String, String>{
  ...
  'operation_failed':
      'تعذر إكمال العملية. حاول مجددًا؛ وإذا استمرت المشكلة، صدّر حزمة تشخيص للحصول على المساعدة.',
  'operation_timeout': 'انتهت مهلة العملية. تحقق من الشبكة وحاول مجددًا.',
  'accounts_reset':
      'تعذر قراءة إعدادات الحساب المحفوظة فتمت إعادة ضبطها. حُفظت نسخة احتياطية على هذا الجهاز. أعد إعداد الحساب.',
  'input_too_long_bytes':
      'النص طويل جدًا. الحد الأقصى {count} بايت UTF-8؛ بعض الأحرف تستخدم أكثر من بايت.',
  'username_colon': 'لا يمكن أن يحتوي اسم المستخدم على النقطتين (:).',
  'username_null': 'يحتوي اسم المستخدم على حرف غير مرئي. امسحه واكتبه مجددًا.',
