...
| PMTU-3 Drop without truncation or spin | `c5e50d3`, PR-12 | MTU1500-to1280, three-error breaker, burst/revalidation-during-migration and receive-truncation tests | `not_run`: PMTU lab | [invariants](reliability-invariants.md) |
